...
public class CreateCustomerJPanel extends javax.swing.JPanel {
    ...
    public CreateCustomerJPanel(JPanel cardSequenceJPanel, Customer customer, CustomerDirectory customreDirectory) {
        initComponents();
        ...
        this.customerDirectory = customreDirectory;
    ...
    private void saveCustomerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveCustomerBtnActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "A new customer saved sucessfully!");
