...
import userInterface.volunteer.hospitalContact.HospitalContactButtonJPanel;
...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void setButton(){
        ...
        if(this.userAccount.getUsername() == null){
            SignUpBtnJPanel signUpBtnJPanel = new SignUpBtnJPanel();
            subJSplitPane2.setLeftComponent(signUpBtnJPanel);
        }else{
            String role = this.userAccount.getRole().toString();
            if(role.equals("Patient")){   
                PatientsButtonJPanel patientBtnJPanel = new PatientsButtonJPanel();
                subJSplitPane2.setLeftComponent(patientBtnJPanel);
            }else if(role.equals("Doctor")){
                DoctorButtonJPanel doctorBtnJPanel = new DoctorButtonJPanel();
                subJSplitPane2.setLeftComponent(doctorBtnJPanel);
            }else if(role.equals("Finance")){
                FinanceButtonJPanel financeBtnJPanel = new FinanceButtonJPanel();
                subJSplitPane2.setLeftComponent(financeBtnJPanel);
            }else if(role.equals("HospitalContact")){
                HospitalContactButtonJPanel hospitalContBtnJPanel = new HospitalContactButtonJPanel();
                subJSplitPane2.setLeftComponent(hospitalContBtnJPanel);
            }else if(role.equals("MedicineManage")){
                MedicineManageButtonJPanel medicineManageButtonJPanel = new MedicineManageButtonJPanel();
                subJSplitPane2.setLeftComponent(medicineManageButtonJPanel);
            }
        }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(mainJSplitPane, javax.swing.GroupLayout.PREFERRED_SIZE, 1196, javax.swing.GroupLayout.PREFERRED_SIZE)
