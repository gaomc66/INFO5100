...
public class PatientsWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private PatientsOrganization organization;
    private Enterprise enterprise;
    private UserAccount userAccount;
    
    
    public PatientsWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, PatientsOrganization organization, Enterprise enterprise) {
        initComponents();
